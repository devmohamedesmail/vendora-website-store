...
import Address_Checkout_Section from './address_checkout_section';
    ...
    return (
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <Address_Checkout_Section userAddress={userAddress} setSelectedAddress={setSelectedAddress} t={t} auth={auth} />
